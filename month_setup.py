...
CARDS = {
    ...
    "3433647a-16dc-80b5-836d-de09460c7bc2": {
        ...
        "categories": [
            {"name": "👥 Підбір і запуск нових наставницьких пар (підлітки, наставники, співбесіди, метчинг, чати, перші зустрічі)", "items": []},
            {"name": "🤝 Супровід і підтримка діючих наставницьких пар (зустрічі, рев'ю, регулярність, проблеми, консультації наставників, завершення пар, оновлення статусів)", "items": []},
            {"name": "🔎 Залучення та відбір нових наставників та підопічних (пошук, комунікація, відбір, донори, компанії, нові набори)", "items": []},
            {"name": "🛠️ Розвиток і вдосконалення системи наставництва (процеси, документи, закон, аналітика, спільнота, нові формати)", "items": []},
